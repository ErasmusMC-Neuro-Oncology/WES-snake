...
option_list <- list(
    ...
    make_option(c("--orientation-min-af"), action="store", type="double",
    default = 0.10,
    help="Rescue orientation flagged variants if AF >= threshold [default %default]"),

    make_option(c("--orientation-min-alt"), action="store", type="integer",
    default = 8,
    help="Rescue orientation flagged variants if ALT reads >= threshold [default %default]"),
